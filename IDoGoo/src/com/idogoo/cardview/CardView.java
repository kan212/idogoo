...
public class CardView extends FrameLayout implements CardViewDelegate {
     ...
     *                         and above.
     * @attr ref com.farpost.cardviewhack.R.styleable#CardView_cardUseCompatPadding
     */
     ...
     * @attr ref com.farpost.cardviewhack.R.styleable#CardView_contentPadding
     * @attr ref com.farpost.cardviewhack.R.styleable#CardView_contentPaddingLeft
     * @attr ref com.farpost.cardviewhack.R.styleable#CardView_contentPaddingTop
     * @attr ref com.farpost.cardviewhack.R.styleable#CardView_contentPaddingRight
     * @attr ref com.farpost.cardviewhack.R.styleable#CardView_contentPaddingBottom
     */
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
	    ...
	    boolean isTopRadiusEnabled = a.getBoolean(R.styleable.CardView_cardCornerRadiusTopEnabled, true);
	    boolean isBottomRadiusEnabled = a.getBoolean(R.styleable.CardView_cardCornerRadiusBottomEnabled, true);
        ...
        a.recycle();
        IMPL.initialize(this, context, backgroundColor, radius, elevation, maxElevation, isTopRadiusEnabled, isBottomRadiusEnabled);
    }
     ...
     * @attr ref com.farpost.cardviewhack.R.styleable#CardView_cardCornerRadius
     * @see #setRadius(float)
     */
	...
	public boolean isTopSideEnabled() {
		return IMPL.isTopSideEnabled(this);
	}

	@Override
	public boolean isBottomSideEnabled() {
		return IMPL.isBottomSideEnabled(this);
	}

	@Override
	public void setEnabledSides(boolean isTopEnabled, boolean isBottomEnabled) {
		IMPL.setEnabledSides(this, isTopEnabled, isBottomEnabled);
	}
     ...
     * @attr ref com.farpost.cardviewhack.R.styleable#CardView_cardElevation
     ...
     * @attr ref com.farpost.cardviewhack.R.styleable#CardView_cardPreventCornerOverlap
