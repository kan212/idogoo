...
interface CardViewImpl {
    void initialize(CardViewDelegate cardView, Context context, int backgroundColor, float radius,
                    float elevation, float maxElevation, boolean isTopSideEnabled, boolean isBottomSideEnabled);
	...
	void setEnabledSides(CardViewDelegate cardView, boolean isTopEnabled, boolean isBottomEnabled);

	boolean isTopSideEnabled(CardViewDelegate cardView);

	boolean isBottomSideEnabled(CardViewDelegate cardView);
}
